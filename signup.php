...
<head>
    ...
    <link rel="icon" href="components/download.png">
</head>
...
<body>
    ...
    <main>
        <div class="containerWperc bcLight dFlex jcCenter">
            <form action="signup.php" method="post" class="my10">
                <div class="input mb3">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "INSERT INTO `usersdata` (`username`, `first_name`, `last_name`, `email`, `password`) VALUES ('strtolower($user)', '$first_name', '$last_name', '$email', '$pass')";
